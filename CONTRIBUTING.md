...
This document is intended to be a living summary of conventions & best practices for development within Tasks Plug-in for Zowe CLI.
...
The following guidelines apply specifically to this Tasks Plug-in for Zowe CLI:
