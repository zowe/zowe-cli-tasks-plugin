...
export default class DownloadMembers extends BaseZosmfFunc {
    protected async execZosmf(params: IFuncParameters, session: Session): Promise<any> {
        ...
        await Download.allMembers(session as any, dataset, {
            binary: params.action.args.binary,
            directory: params.action.args.dest,
            extension: params.action.args.extension,
